...
import ../exports/[edl, presets, project]
...
```nim
  if analyzeOnly:
    ...
    # FCPXML would need fcp11.nim integration
    echo "Note: FCPXML export not yet implemented"
...
3. `honeyclip export video.mp4 --analyze-only` exports JSON, EDL, FCPXML
