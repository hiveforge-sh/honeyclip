...
# Run from project root: .\scripts\prerequisites.ps1
...
Write-Host ""
Write-Host "[4/5] Installing pyannote.audio (speaker diarization)..." -ForegroundColor Cyan
...
Write-Host "     .venv\Scripts\python.exe -c `"from pyannote.audio import Pipeline; print('OK')`"" -ForegroundColor Cyan
Write-Host ""
